...
if [ -d ".git" ]; then
    ...
    if [ -f "apps/scraper-worker/.git" ]; then
        git -C apps/scraper-worker config pull.rebase true
        git -C apps/scraper-worker config pull.ff false
        git -C apps/scraper-worker config merge.ff false
        git -C apps/scraper-worker config branch.main.rebase true
    fi
