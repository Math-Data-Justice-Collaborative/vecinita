...
def env_vars():
    ...
    return {
        ...
        "MODAL_FUNCTION_INVOCATION": _env_or_default("MODAL_FUNCTION_INVOCATION", "auto"),
        "MODAL_TOKEN_ID": _env_or_default("MODAL_TOKEN_ID", "ak-test"),
        "MODAL_TOKEN_SECRET": _env_or_default("MODAL_TOKEN_SECRET", "as-test"),
