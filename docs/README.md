# Vecinita Documentation Hub

Comprehensive technical documentation for the Vecinita bilingual Q&A assistant. **108 tests passing | Production Ready**
...
### 🔧 **Backend Developer**
- [BACKEND_ENVIRONMENT_SETUP.md](BACKEND_ENVIRONMENT_SETUP.md) - Local dev configuration
- [LOCAL_SUPABASE_SETUP.md](LOCAL_SUPABASE_SETUP.md) - Docker Supabase for development
- [LANGGRAPH_REFACTOR_SUMMARY.md](LANGGRAPH_REFACTOR_SUMMARY.md) - Agent architecture
- [architecture/SCRAPER_ORGANIZATION.md](architecture/SCRAPER_ORGANIZATION.md) - Scraper design
- [features/CHUNKING_UPLOAD_PIPELINE.md](features/CHUNKING_UPLOAD_PIPELINE.md) - Data pipeline
- [tools/DB_CLI_USAGE.md](tools/DB_CLI_USAGE.md) - Database tools

### 🎨 **Frontend Developer**
- [../frontend/README.md](../frontend/README.md) - Frontend setup
- [STREAMING_UX_SUMMARY.md](STREAMING_UX_SUMMARY.md) - UX features
- [features/STREAMING_MODE.md](features/STREAMING_MODE.md) - Streaming implementation
...
| [features/STREAMING_MODE_COMPLETE.md](features/STREAMING_MODE_COMPLETE.md) | Implementation details |
| [features/HTML_CLEANER_README.md](features/HTML_CLEANER_README.md) | Content extraction & cleanup |
| [features/CHUNKING_UPLOAD_PIPELINE.md](features/CHUNKING_UPLOAD_PIPELINE.md) | Data ingestion pipeline |
| [STREAMING_UX_SUMMARY.md](STREAMING_UX_SUMMARY.md) | Enhanced streaming with planning |
| [SOURCE_TITLE_CLEANUP.md](SOURCE_TITLE_CLEANUP.md) | Source attribution improvements |

### 🛠️ **Tools & Utilities** (tools/)
| Document | Purpose |
|----------|---------|
| [tools/DB_CLI_USAGE.md](tools/DB_CLI_USAGE.md) | Database CLI guide |
| [tools/DB_CLI_SUMMARY.md](tools/DB_CLI_SUMMARY.md) | DB CLI quick reference |

### 📚 **Guides & How-Tos** (guides/)
| Document | Purpose |
|----------|---------|
| [guides/ENHANCED_LOGGING.md](guides/ENHANCED_LOGGING.md) | Logging configuration & best practices |
| [guides/LOGGING_QUICK_REFERENCE.md](guides/LOGGING_QUICK_REFERENCE.md) | Logging quick reference |
| [guides/BEFORE_AFTER_GUIDE.md](guides/BEFORE_AFTER_GUIDE.md) | Feature comparison examples |
| [guides/EDGE_FUNCTION_DEPLOYMENT.md](guides/EDGE_FUNCTION_DEPLOYMENT.md) | Edge function setup |
...
- → [LANGGRAPH_REFACTOR_SUMMARY.md](LANGGRAPH_REFACTOR_SUMMARY.md)
- → [architecture/NEW_CODE_STRUCTURE.md](architecture/NEW_CODE_STRUCTURE.md)
- → [architecture/SCRAPER_ORGANIZATION.md](architecture/SCRAPER_ORGANIZATION.md)

**...implement new features**
- → [TEST_COVERAGE_SUMMARY.md](TEST_COVERAGE_SUMMARY.md)
- → [STREAMING_UX_SUMMARY.md](STREAMING_UX_SUMMARY.md)
- → [architecture/NEW_CODE_STRUCTURE.md](architecture/NEW_CODE_STRUCTURE.md)
...
- → Coverage: [TEST_COVERAGE_SUMMARY.md](TEST_COVERAGE_SUMMARY.md)
...
- Update this README and INDEX.md
...
**Total Docs**: 40+ files organized by category
