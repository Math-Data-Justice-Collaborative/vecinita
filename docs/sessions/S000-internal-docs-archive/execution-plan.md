...
| **Active task** | **T84.3** (in_progress) — Code: api/jobs client events/cancel/retry/delete |
| **Tasks completed** | Phase 17–18 historical; Phase 19: T82.1–T82.6 (M82); T83.1–T83.6 (M83); T84.1 |
...
| T84.3 | Code: `api/jobs` client — events/cancel/retry/delete + types | Code | in_progress | TP-S013-01 | T84.1 | — | S013 | F32 |
...
| T84.3 | M84 | 19 | Code | in_progress | T84.1 | — | S013 | F32 | — |
