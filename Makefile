...
help:
	...
	@echo "  make test-schemathesis-cli               Schemathesis CLI (loads .env; AGENT_SCHEMA_URL / GATEWAY_SCHEMA_URL; optional GATEWAY_LIVE_BEARER)"
	@echo "                                           Optional: SCHEMATHESIS_MODAL_MICROSERVICES=1 + MODAL_*_SCHEMA_URL for embedding/scraper/model Modal OpenAPI"
	@echo ""
