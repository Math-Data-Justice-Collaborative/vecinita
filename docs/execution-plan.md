...
| T32.3 | Config: scaffold `packages/frontend-i18n` + `packages/frontend-ui` (package.json, tsconfig, vitest) | Config | in_progress | spec.md §Frontend i18n/UI, ADR-019/020 | T32.2 | — | EV-004 | F31 |
