...
| Task | Description | Type | Status | Spec Source | Depends On | Completed | Session | Feature |
|------|-------------|------|--------|-------------|------------|-----------|---------|---------|
| T111.1 | Test: API e2e `test_uj064_robust_scrape.py` (TC-199) | Test | pending | UJ-064, e2e-coverage | T108.6 | — | S024 | F59 |
| T111.2 | Test: API e2e `test_uj065_website_crawl.py` (TC-202); optional Playwright UJ-065 | Test | pending | UJ-065, TP4 | T109.6 | — | S024 | F60 |
