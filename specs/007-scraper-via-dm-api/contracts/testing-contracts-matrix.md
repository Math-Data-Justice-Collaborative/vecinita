...
| Scraper RPC shapes | Request/response parity with fixtures | Reuse patterns from `apis/data-management-api/tests/parity/test_remote_clients_parity.py`; extend for Modal envelopes |
...
- DM API tests: `apis/data-management-api/tests/` (+ package tests).
