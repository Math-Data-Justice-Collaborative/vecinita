...
| **Active task** | **T83.5** (pending) — Code: eval SSE + DELETE soft-deletes linked eval_run |
| **Tasks completed** | Phase 17–18 historical; Phase 19: T82.1–T82.6 (M82); T83.1–T83.4 |
| **Last updated** | 2026-07-28 |
| **Evolve cycle** | EV-012 (F32/F36) — **07-build in progress** (Lean+build); M83 @ T83.5 after T83.2/T83.3 |
