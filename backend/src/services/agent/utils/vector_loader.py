...
class VecinitaLoader:
    ...
    def __init__(self):
        ...
        if USE_LOCAL_EMBEDDINGS and LOCAL_EMBEDDINGS_AVAILABLE:
            ...
            logger.warning(
                "Local embeddings are unavailable. Proceeding without embeddings. "
                "Install sentence-transformers or set USE_LOCAL_EMBEDDINGS=true with a local model available."
            )
