...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        print(
            "Usage: python migrate_model.py <db_url> <source_table> <target_provider> <target_model>"
        )
        print(
            "Example: python migrate_model.py postgres://... document_chunks_huggingface_miniLMv2 openai text-embedding-3-small"
        )
        sys.exit(1)
