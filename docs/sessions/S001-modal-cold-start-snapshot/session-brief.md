...
> `docs/sessions/S000-internal-docs-archive/reference.md#cost-monitoring-baseline-adr-004` (no change expected), `infra/modal/llm_app.py`
...
- Constraints: ADR-004 (cost), ADR-009 (vLLM on T4), `docs/sessions/S000-internal-docs-archive/reference.md#cost-monitoring-baseline-adr-004`
