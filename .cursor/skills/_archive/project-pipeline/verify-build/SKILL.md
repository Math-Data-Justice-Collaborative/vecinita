...
1. **Execution plan**: `docs/sessions/S000-internal-docs-archive/execution-plan.md` must exist to determine the tech stack
...
applies only when `docs/test-plan.md` or `docs/sessions/S000-internal-docs-archive/execution-plan.md` defines commands, markers,
...
- Cross-reference `docs/sessions/S000-internal-docs-archive/execution-plan.md` §Data Dependencies — flag any asset that is
