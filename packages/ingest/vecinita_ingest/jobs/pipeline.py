...
from vecinita_ingest.jobs.protocols import (
    CorpusWriteClientProtocol,
    JobRecordProtocol,
    JobStoreProtocol,
)
...
def _ingest_one_url(  # noqa: PLR0913  # mirrors run_ingest_job stage branches
    ...
    *,
    ...
    write_client: CorpusWriteClientProtocol,
...
def _eval_run_id_from_record(record: JobRecordProtocol) -> UUID:
