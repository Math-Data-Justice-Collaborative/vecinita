...
- [Multi-Repo CI/CD Orchestration](deployment/MULTI_REPO_CICD_ORCHESTRATION.md) - Parent workflow dispatch model for chat, data-management, routing, and modal services
- [Microservices Compose Stack](deployment/MICROSERVICES_COMPOSE_STACK.md) - Local routing-centric stack for chat + data-management + modal services
