...
| **Active task** | T111.2 — API e2e UJ-065 website crawl |
| **Tasks completed** | Phase 21–25 complete; M108–M110 done; T111.1 done |
...
| T111.2 | Test: API e2e `test_uj065_website_crawl.py` (TC-202); optional Playwright UJ-065 | Test | in_progress | UJ-065, TP4 | T109.6 | — | S024 | F60 |
| T111.3 | Test: API e2e `test_uj066_corpus_tree.py` (TC-204) green with T110 | Test | pending | UJ-066, AC-SC8/SC11 | T110.5 | — | S024 | F61 |
...
| T111.2 | M111 | 26 | Test | in_progress | T109.6 | — | S024 | F60 | — |
