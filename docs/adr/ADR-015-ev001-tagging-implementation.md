...
| LLM cost (EV-001) | **Within existing ≤ $50/mo cap** | Extra ingest + inference calls at pilot volume; monitor via docs/sessions/S000-internal-docs-archive/reference.md#cost-monitoring-baseline-adr-004 |
