...
| 7 | 2026-05-22 | Code bug | Admin GET /jobs/{id} 404 — InMemoryJobStore per container; modal.Dict shared store | [BUG-2026-05-22-admin-jobs-get-404-not-found.md](bug-reports/BUG-2026-05-22-admin-jobs-get-404-not-found.md) | main (uncommitted) | — | Modal data-mgmt 2026-05-22 | L1–L4 pass |
