...
Highlights: Admin-only; extend F32/F36; v1+v2; FE federation; `/jobs/:id`; SSE per source; #116 ACs + UJ-023; Lean+build.
...
| `docs/test-plan.md` | TCs for list federation, detail, SSE, cancel, retag document_id |
