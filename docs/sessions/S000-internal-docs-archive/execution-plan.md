...
| **Active task** | T120.3b — F36 EN/ES report columns |
| **Tasks completed** | Phase 21–27; S027 Phase A/B; M119 (PR #208 merged @`2c884bd`); S027-D34 CI split; T120.1–T120.3 |
...
| T83.3 | Config: Alembic — `eval_runs.deleted_at` nullable timestamptz | Config | completed | TP-S013-05 | T83.2 | 2026-07-28 | S013 | F36 |
...
| T83.5 | Code: `GET /internal/v1/eval/runs/{run_id}/events` SSE; DELETE job soft-deletes linked eval_run | Code | completed | TP-S013-03/04 | T83.2, T83.3, T83.4 | 2026-07-28 | S013 | F36 |
| T83.6 | Config: `openapi/internal-write.yaml` events path + EvalRun soft-delete fields | Config | completed | TP-S013-04 | T83.5 | 2026-07-28 | S013 | F36 |
...
| Task | Description | Type | Status | Spec Source | Depends On | Completed | Session | Feature |
|------|-------------|------|--------|-------------|------------|-----------|---------|---------|
| T84.1 | Test: Vitest — Jobs list filter, detail route, SSE→poll fallback (TC-148/150/151) — red | Test | completed | RD-173/178, TC-148/150/151 | T82.5 | 2026-07-28 | S013 | F32 |
...
| T96.2 | Test: unit/e2e — flag default off keeps L0-strict (TC-181) — red | Test | completed | AC-BB6, TC-181, UJ-058 | — | 2026-08-02 | S020 | F44 |
| T96.3 | Code: `packages/rag` soft-language retrieve helper + ChatRAG flag wire | Code | completed | spec.md F44, config-spec | T96.1, T96.2 | 2026-08-02 | S020 | F44 |
| T96.4 | Test: empty-hit fixture + `tests/e2e/test_uj058_soft_language.py` green | Test | completed | UJ-058, e2e-coverage | T96.3 | 2026-08-02 | S020 | F44 |
...
| T97.3 | Code: mockable CE client in `packages/rag` + ChatRAG flag-gated hook | Code | completed | feature-list F45, M3 | T97.1, T97.2 | 2026-08-02 | S020 | F45 |
| T97.4 | Config: ephemeral Modal T4 CE spike app/script (S019 pattern; no playground URL) | Config | completed | RD-204, S020-D11/D15 | T97.3 | 2026-08-02 | S020 | F45 |
| T97.5 | Docs: spike runbook + metrics capture path for ship gate | Docs | completed | TC-184, UJ-060 | T97.4 | 2026-08-02 | S020 | F45 |
...
| T99.4 | Test: e2e green; unit helpers as needed; optional `BUG-*` if code repro (S021-D14) | Test | completed | e2e-coverage, AC-FO1/FO2 | T99.3 | 2026-08-02 | S021 | F46 |
| T99.5 | Docs: session diagnose note + root-cause class; staging UJ-061 evidence path | Docs | completed | UJ-061, AC-FO1 | T99.4 | 2026-08-02 | S021 | F46 |
...
| Task | Description | Type | Status | Spec Source | Depends On | Completed | Session | Feature |
|------|-------------|------|--------|-------------|------------|-----------|---------|---------|
| T105.1 | Test: unit red — `DEFAULT_TOP_K` / ChatRAG settings default is 8 when env unset (TC-193) | Test | completed | AC-RQ8, F50, #158 | — | 2026-08-03 | S023 | F50 |
| T105.2 | Config: `infra/do/chat-rag-backend.yaml` `VECINITA_TOP_K=8`; align any shared-schema EvalConfig default | Config | completed | config-spec, RD-230, RD-234 | — | 2026-08-03 | S023 | F50 |
| T105.3 | Code: `packages/rag` `DEFAULT_TOP_K=8`; ChatRAG settings `_int_env("VECINITA_TOP_K", 8)`; engine defaults | Code | completed | feature-list F50, RD-230 | T105.1, T105.2 | 2026-08-03 | S023 | F50 |
| T105.4 | Test: unit green for top_k default 8 | Test | completed | AC-RQ8, TC-193 | T105.3 | 2026-08-03 | S023 | F50 |
...
| T117.4 | Test: e2e + Vitest green (TC-229–230); Playwright optional | Test | completed | TP4 | T117.3 | 2026-08-04 | S026 | F69 |
...
| T120.3b | Code: eval/F36 report — EN/ES rel+faith vs E0 baseline columns + dense hit@k/mean_rank when available (TC-235–236) | Code | in_progress | AC-ME3–ME4, S027-D18, F36 | T120.1, T120.3 | — | S027 | F71 |
...
| T82.2 | M82 | 19 | Test | completed | — | 2026-07-28 | S013 | F32 | — |
...
| T83.3 | M83 | 19 | Config | completed | T83.2 | 2026-07-28 | S013 | F36 | — |
| T83.4 | M83 | 19 | Code | completed | T83.1, T82.4 | 2026-07-28 | S013 | F36 | — |
| T83.5 | M83 | 19 | Code | completed | T83.2, T83.3, T83.4 | 2026-07-28 | S013 | F36 | — |
| T83.6 | M83 | 19 | Config | completed | T83.5 | 2026-07-28 | S013 | F36 | — |
| T84.1 | M84 | 19 | Test | completed | T82.5 | 2026-07-28 | S013 | F32 | — |
...
| T96.2 | M96 | 22 | Test | completed | — | — | S020 | F44 | — |
