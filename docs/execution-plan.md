...
| **Active task** | **T69.5** — Compare runs view *(next)* |
| **Tasks completed** | Phase 14 M59–M64 complete (S007); Phase 15 M65–M67 complete (S008); M68 complete (S008); T69.4 complete (S008) |
