...
| 6 | 2026-05-22 | Code bug | Admin POST /jobs 401 — Modal-Key reserved; use X-Vecinita-Proxy-Key | [BUG-2026-05-22-admin-jobs-401-unauthorized.md](bug-reports/BUG-2026-05-22-admin-jobs-401-unauthorized.md) | — | — | Modal data-mgmt 2026-05-22 | API L1+L3 pass; FE pending main |
