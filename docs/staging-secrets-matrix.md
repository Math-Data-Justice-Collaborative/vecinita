...
| `VECINITA_RAG_OUTPUT_VERIFY` | No (default `false`) | F82 post-generation faithfulness judge + citations; **staging `true`** after F36 non-regression; prod stays `false` (AC-OV7) |
