...
| 4 | 2026-05-22 | Code bug | Admin DELETE document Failed to fetch — CORS missing DELETE method | [BUG-2026-05-22-delete-document-failed-to-fetch.md](bug-reports/BUG-2026-05-22-delete-document-failed-to-fetch.md) | main | — | DO internal-write-api | pending L4 |
