...
const esStrings = {
  ...
  "admin.documentAdmin.refreshEnabledLabel": "Actualización programada de frescura",
  ...
  "admin.documentAdmin.refreshEnabledSaved": "Configuración de frescura guardada.",
  "admin.documentAdmin.saveRefreshEnabledFailed":
